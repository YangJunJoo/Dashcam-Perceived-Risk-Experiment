...
**"Autonomous Vehicles Change How People Judge Risk in Near-misses"** (Joo et al., 2026), currently under review (first round) in *IEEE Transactions on Intelligent Transportation Systems (T-ITS)*. SSRN: [https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5437729](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5437729)
